...
# Revisión mensual de cambios upstream: ggplot2-book
...
- **Upstream:** `hadley/ggplot2-book`, rama `main`
...
`hadley/ggplot2-book` rama `main` de los últimos 30 días (desde
...
en la rama `main` de `hadley/ggplot2-book`.
